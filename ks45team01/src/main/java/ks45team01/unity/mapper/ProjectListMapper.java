...
// projectList
	...
	//프로젝트 등록 ->/project/projectInsert
	void ProjectInsert(ProjectList projectList);
	
	//프로젝트 등록 자동증가 코드
	String projectCode (String table,String column);
...
//projectMemberInsert
	...
	//인원배정리스트 등록
		...
		// tb_project_member랑 tb_member 조인해서 전체 조회
		List<ProjectMember> projectMemberList(String projectNum);

		//tb_member랑 tb_department_list 조인 후 조회 페이징도 있는거같은데?
